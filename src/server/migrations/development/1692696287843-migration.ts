...
export class Migration1692696287843 implements MigrationInterface {
    name = 'Migration1692696287843'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users_days" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "points" smallint NOT NULL DEFAULT '0', "adenas" integer NOT NULL DEFAULT '0', "userId" uuid NOT NULL, "dayId" uuid NOT NULL, CONSTRAINT "PK_60cab3f8fdd7d1640a5c241c500" PRIMARY KEY ("id"))`);
