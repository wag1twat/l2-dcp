...
export class Migration1692624277413 implements MigrationInterface {
    name = 'Migration1692624277413'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "days_options" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "count" smallint NOT NULL DEFAULT '0', "dayId" uuid, "optionId" uuid, CONSTRAINT "PK_c9d11313d1165d8c0343c9db515" PRIMARY KEY ("id"))`);
